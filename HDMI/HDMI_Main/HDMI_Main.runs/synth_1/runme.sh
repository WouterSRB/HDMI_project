...
HD_PWD='C:/Users/vsoab/Documents/GitHub/HDMI_project/HDMI/HDMI_Main/HDMI_Main.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_diagram_HDMI_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_diagram_HDMI_wrapper.tcl
