...
HD_PWD='C:/Users/vsoab/Documents/GitHub/HDMI_project/HDMI/HDMI_Main/HDMI_Main.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log block_diagram_HDMI_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source block_diagram_HDMI_wrapper.tcl -notrace
